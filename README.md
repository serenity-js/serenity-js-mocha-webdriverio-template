...
of web applications using [**Serenity/JS**](https://serenity-js.org), [**Mocha**](https://mochajs.org/), and [**WebdriverIO**](https://webdriver.io/),
...
- [Serenity/JS HTML Report](https://serenity-js.github.io/serenity-js-mocha-webdriverio-template/)

## Features

- Pre-configured **Serenity/JS** + **Mocha** + **WebdriverIO** + **TypeScript** setup
...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://github.com/codespaces/new?ref=main&repo=serenity-js/serenity-js-mocha-webdriverio-template)
...
npm test -- --spec "test/specs/**/*.spec.ts"
```
...
├── serenity/
│   ├── github-api/
│   │   └── GitHubStatus.ts               # Example API-related tasks
│   └── todo-list-app/
│       ├── TodoList.ts                   # Example page objects
│       └── TodoListItem.ts
└── specs/
    └── serenity-js_website.spec.ts       # Mocha test scenarios
...
**Key files:**
- `test/specs/*.spec.ts` - Mocha test scenarios
- `test/serenity/` - Tasks, questions, and page objects following the [Screenplay Pattern](https://serenity-js.org/handbook/design/screenplay-pattern/)

## Next steps

- Update `baseUrl` in [`wdio.conf.ts`](wdio.conf.ts) to point to your application
- Add your test specs to `test/specs/` following the examples
